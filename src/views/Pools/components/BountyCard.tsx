...
const BountyCard = () => {
  ...
  const TooltipComponent = () => (
    <>
      ...
      <Text mb="16px">
        Whenever you successfully claim the bounty, you’re also helping out by activating the Auto SEED Pool’s compounding function for everyone.
      </Text>
      <Text style={{ fontWeight: 'bold' }}>
        {`Auto-Compound Bounty: ${ callFee / 100 }% of all Auto SEED pool users’ pending yield`}
      </Text>
    </>
  )
